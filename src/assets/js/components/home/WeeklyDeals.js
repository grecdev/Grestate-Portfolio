  ...
  return (
    <section id='weekly-deals'>
      <Container className='py-5'>
        ...
        <Row>
          <Col className='p-1 col-lg-7 position-relative d-flex flex-column justify-content-center'>
          ...
          <Col className='p-1 col-lg-5 position-relative d-flex flex-column justify-content-center'>
            <div className='overlay-image overlay-image-2'>
