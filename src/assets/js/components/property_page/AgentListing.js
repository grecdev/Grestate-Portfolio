...
const AgentListing = ({ agent }) => {
  ...
  return (
    <section id='agent-listing'>
      <div className='text-center d-flex flex-column justify-content-start align-items-center border rounded'>
        ...
        <div className='agent-card-info mb-3 py-4 text-white text-center rounded'>
          <div className='number d-flex flex-row justify-content-center align-items-center mb-3'>
            <p className='m-0'></p>
            <p className='m-0 ml-3' onClick={showNumber}>
              Show number
            </p>
          </div>
      ...
      <div className='agent-card-footer py-4 px-5 d-flex flex-column justify-content-center align-items-stretch rounded-bottom'>
        <button type='button' className='mb-2 p-2 border-0 outline-none'>
          Contact Agent
        </button>
        <button type='button' className='p-2 outline-none'>
          Find other Agent
        </button>
      </div>
    </section>
