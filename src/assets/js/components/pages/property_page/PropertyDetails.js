	...
	return (
		<section id='property-details' className='pr-5'>
			...
			<div className="property-details-header d-flex flex-row justify-content-start align-items-start py-3">
				...
				{propertyRent && <p className="price d-flex flex-row justify-content-start align-items-center font-weight-bold">$ {parseFloat(propertyRent).toLocaleString()} <span className='ml-2'>/ month</span></p>}
			...
			<div className="property-details-info py-3">
				<div className='d-flex flex-row justify-content-between align-items-center'>
					...
					<div className="info-box text-center">
						...
						<p className='font-weight-bold'>{bedrooms} <i className="fas fa-bed ml-2"></i></p>
					</div>

					<div className="info-box text-center">
						<h3 className='text-secondary font-weight-light'>Bathrooms</h3>
						<p className='font-weight-bold'>{bathrooms} <i className="fas fa-bath ml-2"></i></p>
					</div>

					<div className="info-box text-center">
						<h3 className='text-secondary font-weight-light'>Property Size</h3>
						<p className='font-weight-bold'>{parseFloat(propertySize).toLocaleString()} ft<sup>2</sup></p>
					</div>
