			...
			<Container>
				...
				<Row className='justify-content-around align-items-end py-3'>
					<Col className='text-center col-lg-3 p-0 small-card'>
						<div className="avatar mb-4"><img src={getImage('billgates-avatar.jpg')} alt='avatar' className='rounded shadow' /></div>
					...
					<Col className='text-center col-lg-3 p-0'>
						<div className="avatar mb-4"><img src={getImage('grecdev-avatar.jpeg')} alt='avatar' className='rounded shadow' /></div>
					...
					<Col className='text-center col-lg-3 p-0 small-card'>
						<div className="avatar mb-4"><img src={getImage('jeffbezos-avatar.jpg')} alt='avatar' className='rounded shadow' /></div>
