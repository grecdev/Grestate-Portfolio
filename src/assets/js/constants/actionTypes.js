...
export const SET_BUY_PROPERTIES = 'SET_BUY_PROPERTIES';
export const FILTER_BUY_PROPERTIES = 'FILTER_BUY_PROPERTIES';
export const SET_RENTAL_PROPERTIES = 'SET_RENTAL_PROPERTIES';
export const FILTER_RENTAL_PROPERTIES = 'FILTER_RENTAL_PROPERTIES';
export const SET_LOADER = 'SET_LOADER';

// Property form
export const HANDLE_PROPERTY_INPUT = 'HANDLE_PROPERTY_INPUT';
export const RESET_PROPERTY_INPUTS = 'RESET_PROPERTY_INPUTS';
...
export const SET_ACCOUNT_INPUTS = 'SET_ACCOUNT_INPUTS';

// Regex
export const SET_REGEX_ALERT = 'SET_REGEX_ALERT';
export const RESET_REGEX_ALERT = 'RESET_REGEX_ALERT';