...
const MortageCalculatorPage = lazy(() =>
  import("./pages/MortageCalculatorPage")
);
...
const App = () => {
  const { login_enabled, signup_enabled, reset_password_enabled } = useContext(
      ...
      >
        ...
        <Switch>
          ...
          <Route
            ...
            component={MortageCalculatorPage}
          />
          ...
          <Route
            exact
            strict
            path="/buy-properties/:house"
            component={PropertyPage}
          />
          <Route
            exact
            strict
            path="/rental-listings/:house"
            component={PropertyPage}
          />
        ...
        {login_enabled || signup_enabled || reset_password_enabled ? (
          <AuthenticationModal />
        ) : null}
